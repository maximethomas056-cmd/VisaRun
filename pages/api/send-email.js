  ...
  <div style="max-width:560px;margin:0 auto;padding:32px 16px;">
    ...
    <div style="background:#ffffff;border-radius:16px;padding:24px;margin-bottom:16px;border:1px solid #e8e3d9;">
      ...
      <div style="background:#edf7f1;border:1px solid #b8e0c8;border-radius:10px;padding:12px 16px;">
        ...
        <span style="color:#1a1a18;font-size:14px;">Click <strong>Sign in</strong> and enter exactly this email:<br/>
          <span style="display:inline-block;margin-top:6px;background:#1a7a4a;color:#fff;padding:4px 12px;border-radius:6px;font-size:13px;font-weight:700;letter-spacing:0.02em;">${normalizedEmail}</span>
        </span>
      </div>
    </div>
