...
<body style="margin:0;padding:0;background:#f5f3ee;font-family:Arial,sans-serif;">
  <div style="max-width:560px;margin:0 auto;padding:32px 16px;">
    ...
    <div style="background:#ffffff;border-radius:16px;padding:24px;margin-bottom:16px;border:1px solid #e8e3d9;">
      ...
      <p style="color:#1a1a18;font-size:15px;margin:0;line-height:1.6;">You now have access to <strong>${EMPLOYER_COUNT} direct employer contacts</strong> across Australia — phone numbers, emails, Instagram and Facebook.<br/><br/>Call them directly, skip the agencies and start working faster.</p>
    </div>
    <div style="background:#ffffff;border-radius:16px;padding:24px;margin-bottom:16px;border:1px solid #e8e3d9;">
    ...
    <div style="text-align:center;margin-bottom:16px;">
      <a href="https://www.visarun.pro" style="display:inline-block;background:#1a7a4a;color:#ffffff;text-decoration:none;padding:15px 40px;border-radius:12px;font-size:15px;font-weight:700;letter-spacing:0.01em;">Open VisaRun now</a>
    </div>
    ...
    <div style="background:#fef9ec;border:1px solid #fde68a;border-radius:16px;padding:20px 24px;margin-bottom:16px;">
      ...
      <p style="color:#1a1a18;font-size:14px;margin:0;line-height:1.6;"><strong>Call directly — don't just email.</strong> Farm managers respect backpackers who make the effort. A 2-minute call beats 10 unanswered emails.</p>
    </div>
