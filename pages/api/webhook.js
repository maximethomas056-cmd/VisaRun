...
import { isValidEmail, normalizeEmail } from "./_security";
...
<body style="margin:0;padding:0;background:#f5f3ee;font-family:Arial,sans-serif;">
  <div style="max-width:560px;margin:0 auto;padding:32px 16px;">
    <div style="background:#1a7a4a;border-radius:16px;padding:36px 24px;text-align:center;margin-bottom:20px;">
      <div style="font-size:32px;line-height:1;margin-bottom:14px;">VisaRun</div>
    ...
    <div style="background:#ffffff;border-radius:16px;padding:24px;margin-bottom:16px;border:1px solid #e8e3d9;">
      ...
      <div style="background:#f5f3ee;border-radius:10px;padding:12px 16px;margin-bottom:8px;">1. Go to <a href="https://www.visarun.pro" style="color:#1a7a4a;font-weight:700;text-decoration:none;">www.visarun.pro</a></div>
      <div style="background:#f5f3ee;border-radius:10px;padding:12px 16px;margin-bottom:8px;">2. Click the <strong>Find Work</strong> tab</div>
      <div style="background:#edf7f1;border:1px solid #b8e0c8;border-radius:10px;padding:12px 16px;">3. Sign in with: <span style="display:inline-block;margin-top:6px;background:#1a7a4a;color:#fff;padding:4px 12px;border-radius:6px;font-size:13px;font-weight:700;">${email}</span></div>
    </div>
    ...
    <div style="background:#edf7f1;border:1px solid #b8e0c8;border-radius:16px;padding:24px;margin-bottom:16px;">
      ...
      <table style="width:100%;border-collapse:collapse;">
        <tr><td style="padding:5px 0;font-size:14px;color:#1a1a18;">Direct phone numbers</td></tr>
        <tr><td style="padding:5px 0;font-size:14px;color:#1a1a18;">Recruitment emails</td></tr>
        <tr><td style="padding:5px 0;font-size:14px;color:#1a1a18;">Official websites</td></tr>
        <tr><td style="padding:5px 0;font-size:14px;color:#1a1a18;">QLD, WA, NSW, VIC, TAS, NT, SA, ACT</td></tr>
        <tr><td style="padding:5px 0;font-size:14px;color:#1a1a18;"><strong>Lifetime access</strong> - pay once, keep forever</td></tr>
      </table>
    </div>
    ...
    <div style="text-align:center;color:#9a9488;font-size:12px;">
      ...
      <p style="margin:0;"><a href="https://www.visarun.pro" style="color:#1a7a4a;text-decoration:none;font-weight:600;">visarun.pro</a></p>
    </div>
  </div>
</body>
</html>`;
        ...
        try {
          const resendRes = await fetch("https://api.resend.com/emails", {
            ...
            body: JSON.stringify({
              ...
              to: [email],
              subject: "VisaRun access is ready",
